...
async def next_page(bot, query):
    ...
    btn.insert(0,
            [
                InlineKeyboardButton("⭕️ Movie", url="https://t.me/movies_for_next"),
                InlineKeyboardButton("Series ⭕️", url="https://t.me/movies_for_next")
            ])
...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
        ...
        buttons = [
            [
                InlineKeyboardButton('⭕️ Support', url='https://t.me/movies_for_next'),
                InlineKeyboardButton('Channel ⭕️', url='https://t.me/movies_for_next')
            ],
            [
                InlineKeyboardButton('🎬 Series & Movie Club 🎬', url=f'https://t.me/movies_for_next')
            ]
            ]
        ...
        buttons = [[
            ...
            InlineKeyboardButton('⭕️ Updates', url='https://t.me/movies_for_next'),
            InlineKeyboardButton('Movie Club ⭕️', url='https://t.me/movies_for_next')
            ],[
        ...
        buttons = [[
            ...
            InlineKeyboardButton('Adult Bot 🔞', url='https://t.me/movies_for_next')
        ]]
        reply_markup = InlineKeyboardMarkup(buttons)
        await query.message.edit_text(
        ...
        buttons = [[
            InlineKeyboardButton('⭕ Status', url='https://t.me/movies_for_next'),
...
async def auto_filter(client, msg, spoll=False):
    ...
    btn.insert(0, [
        InlineKeyboardButton("⭕️ Join Our Channel ⭕️",url="https://t.me/movies_for_next")
    ])
